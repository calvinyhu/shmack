  ...
  return dispatch => {
    ...
    preferencesRef
      ...
      .then(doc => {
        ...
        } else dispatch(getYourPlacesEmpty());
      })
      .catch(error => {
        ...
        if (doc.exists) {
          navigator.geolocation.getCurrentPosition(
            response => {
              ...
              const queries = Object.keys(doc.data()).map(cuisine =>
              ...
              axios
                ...
                .then(
                  axios.spread((...responses) =>
                    dispatch(getYourCuisinesSuccess(doc.data(), responses))
                  )
                );
            },
            error => {}
          );
        } else dispatch(getYourCuisinesEmpty());
      })
      .catch(error => {
